...
#		event_run = filelist[nums].split('/')[-1].split('.')[-3]
		tray = I3Tray()
		tray.AddModule('I3Reader','read_stuff',Filenamelist=filelist[nums])
		...
		DoLLReconstructions(tray=tray, Pulses = 'SplitInIcePulses', suffix  = 'RIDE')
		do_Finite_reco(tray=tray,Pulses='SplitInIcePulses',suffix='RIDE')
